...
def format_np_output(np_arr):
    ...
    # Phase/Case X: Np arr is of shape 64xWxH
    # Result: Take the average? Convert it to WxHx3 in order to make it saveable by PIL
    # if np_arr.shape[0] > 64:
    #     np_arr = np_arr[0:3, :, :]
...
def get_adversarial_params(example_index):
    """
        Get the variables for the adversarial visuzalization
    ...
    example_list = (('../input_images/CIFAR10_1.png', 9),
                    ('../input_images/CIFAR10_100.png', 8),
